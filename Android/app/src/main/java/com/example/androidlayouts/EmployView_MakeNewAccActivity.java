...
public class EmployView_MakeNewAccActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    final Translator translator = new Translator(EmployView_MakeNewAccActivity.this);
    ...
    create.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        employeeInterface.setContext(EmployView_MakeNewAccActivity.this);
